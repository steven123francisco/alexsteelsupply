			...
			<div class="container">
                ...
                <div id="section" class="col-md-9">
                        <div class="panel panel-default">
                                                ...
                                                <input type="checkbox" class="checkbox-btn" name="SELECITEM" value="ITEM"> &nbsp SELECT ALL ITEM(S)<br>
                                                </div>
                           
                           
                           
                                                <div class="panel-body">
                                                <input type="checkbox" class="checkbox-btn" name="SELECTITEM" value="ITEM"><div class="cart-list">
